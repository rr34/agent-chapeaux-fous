...
test("video word timing aligns transcription tokens to visible conversation tokens", () => {
  const text = "I can't overlook **Chapeaux Fous** or MariaDB.";
  const words = ["I", "can", "t", "overlook", "Chapeaux", "Fou", "or", "MariaDB"]
  ...
  assert.deepEqual(
    ...
    ["I", "can't", "can't", "overlook", "**Chapeaux", "Fous**", "or", "MariaDB."],
  );
});
