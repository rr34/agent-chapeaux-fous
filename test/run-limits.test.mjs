...
test("run limits accept bounded values and explicit unlimited settings", () => {
  ...
  assert.deepEqual(normalizeRunLimits({ maxToolCalls: 256, timeoutMs: 3_600_000 }), {
    maxToolCalls: 256,
    timeoutMs: 3_600_000,
    promptForTurnBrief: false,
  });
  assert.deepEqual(normalizeRunLimits({
    maxToolCalls: null, timeoutMs: null, promptForTurnBrief: true,
  }), {
    maxToolCalls: null,
    timeoutMs: null,
    promptForTurnBrief: true,
  });
  ...
  assert.throws(
    () => normalizeRunLimits({ maxToolCalls: 20, timeoutMs: 60_000, promptForTurnBrief: "yes" }),
    /promptForTurnBrief/,
  );
});
