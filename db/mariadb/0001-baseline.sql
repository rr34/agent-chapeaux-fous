...
CREATE TABLE jmap_email_sync_state (
    -- sourceOfTruth: true
    -- synonyms: ["JMAP email cursor", "email synchronization state"]
    -- keywords: ["JMAP state", "email sync cursor", "incremental email import"]
...
-- internet_message_id inheritsFrom: correspondence.internet_message_id
