...
export const orientationInstructions = [
  ...
  "When the user names a type advertised as a first-class object, select its cataloged read tool before a broad listing tool when that read can identify the object and its stable reference.",
