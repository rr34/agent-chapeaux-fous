...
const descriptions = new Map(Object.entries({
  ...
  calendar_routine_generate: create("Generate missing concrete calendar events for active routines in a bounded range, idempotently."),
  calendar_event_todo_links_set: update("Replace the many-to-many to-do links on one calendar event with explicit work, deadline, or context semantics."),
